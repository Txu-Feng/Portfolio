...
import cv from '../assets/cv_txu-feng_ly.pdf'
...
const About = () => {
    return (
        ...
        <div id='About' className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col justify-between lg:gap-28 items-center bg-neutral-800">
            <img data-aos="fade-down" src={img} width={290} height={290} className='rounded-xl p-1' alt="image de ly txu-feng" />
                ...
                <div className="flex mt-8 gap-2">
                    <div className="flex items-center justify-center">
                        <div className="flex space-x-2">
                            <button className="neno-button shadow-xl  text-white border-2 hover:bg-neutral-900 border-amber-600 bg-amber-600 rounded-lg py-4 px-8 uppercase relative overflow-hidden" onClick={() => window.open(cv)}>Resume</button>
                        </div>
                    </div>
                </div>
            </div>
